namespace MyNetworkGame.TCPServer.UnoFlipV2
{
    public class Utils
    {
        ...
        public static CardColor PickRandomColour()
        {
            ...
            int randomIndex = random.Next(0, colours.Length - 1);
    ...
    public class RoleAction
    {
        ...
        /*
        /// <summary>
        /// 从网络消息中解析出的action需要设置id
        /// </summary>
        /// <param name="actToClone"></param>
        public RoleAction(RoleAction actToClone)
        {
            actionId = nextActionId;
            type = actToClone.type;
            cardId = actToClone.cardId;
            color = actToClone.color;
        }*/
        ...
        {
            return cardId < 0 ? $"cardId {cardId}" : $"{type} {gameData.deck.CardsDic[cardId]} {color}";
        }
